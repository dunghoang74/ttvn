...
class SJB_SocialPlugin
{
	...
	public static function ifUserIsRegistered($network, $profileSocialID = null)
	{
		if (self::$oProfile && $network && empty($profileSocialID)) {
	...
	public static function login()
	{
		if (self::$oSocialPlugin) {
			...
			$networkProfileID = !empty(self::$oProfile['id']) ? self::$oProfile['id'] : '';
			$errors = array();
			if ($userSID = self::ifUserIsRegistered(self::getNetwork(), $networkProfileID)) {
