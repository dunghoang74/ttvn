<?php /* Smarty version Smarty-3.1.13, created on 2014-12-22 20:57:51
         compiled from "template_generationx_user:main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:168785498235f939103-76681295%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4f8cd36cff2b535b4e85a718536cf308b953418c' => 
    array (
      0 => 'template_generationx_user:main.tpl',
      1 => 1390528918,
      2 => 'template_generationx_user',
    ),
  ),
  'nocache_hash' => '168785498235f939103-76681295',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5498236301d115_79028286',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5498236301d115_79028286')) {function content_5498236301d115_79028286($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
...
Featured Companies<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
			...
			<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['module'][0][0]->module(array('name'=>"users",'function'=>"featured_profiles",'number_of_cols'=>"2",'items_count'=>"4"),$_smarty_tpl);?>

		</div>
		<div class="clr"><br/><br/></div>

		<h1 style="color: #3e7b08;"><?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
Featured Jobs<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
		...
		<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['module'][0][0]->module(array('name'=>"classifieds",'function'=>"featured_listings",'number_of_cols'=>"4",'items_count'=>"8",'listing_type'=>"Job"),$_smarty_tpl);?>
		...
		<div class="JsAndEmpBlock">
			<div class="JsAndEmpBlockPic"></div>
				<div class="quickLinkBlock">
					<div class="JsEmpButton"><?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
<span class="RSS"><a href="<?php echo $_smarty_tpl->tpl_vars['GLOBALS']->value['site_url'];?>
/listing-feeds/?feedId=10">RSS</a></span></h1>
		<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['module'][0][0]->module(array('name'=>"classifieds",'function'=>"latest_listings",'number_of_cols'=>"4",'items_count'=>"8",'listing_type'=>"Job"),$_smarty_tpl);?>
	...
	<div class="rightColumn">
		...
		<?php if ($_smarty_tpl->tpl_vars['GLOBALS']->value['settings']['show_news_on_main_page']){?>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr>
					<td valign="top" style="background:white;"><img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-up.png" border="0" alt="" style="display:block;"/><br/><div class="JobsPanelHeader"><?php $_smarty_tpl->smarty->_tag_stack[] = array('tr', array()); $_block_repeat=true; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
News<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo $_smarty_tpl->smarty->registered_plugins['block']['tr'][0][0]->translate(array(), $_block_content, $_smarty_tpl, $_block_repeat); } array_pop($_smarty_tpl->smarty->_tag_stack);?>
					...
					<td valign="top"><img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-up-2.png" border="0" alt=""/></td>
				</tr>
				<tr>
					<td style="background: url('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-down.png') #ffffff; background-position: bottom; background-repeat: no-repeat;">
						<br/><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['module'][0][0]->module(array('name'=>"news",'function'=>"show_news"),$_smarty_tpl);?>
<br/>
					</td>
					<td style="background-image: url('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-bg.png');" valign="bottom"><img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-down-2.png" border="0" alt=""/></td>
				</tr>
			</table>
		<?php }?>
		<br/>
...
right-panel-up-2.png" border="0" alt=""/></td>
				...
				<tr>
					<td style="background: url('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-down.png') #ffffff; background-position: bottom; background-repeat: no-repeat;">
						<br /><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['module'][0][0]->module(array('name'=>"classifieds",'function'=>"browse",'browseUrl'=>"/browse-by-category/",'browse_template'=>"browse_by_category.tpl"),$_smarty_tpl);?>
<br />
					</td>
					<td style="background-image: url('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-bg.png');" valign="bottom"><img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
...
right-panel-up-2.png" border="0" alt=""/></td>
				...
				<tr>
					<td style="background: url('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-down.png') #ffffff; background-position: bottom; background-repeat: no-repeat;">
						<br /><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['module'][0][0]->module(array('name'=>"classifieds",'function'=>"browse",'browseUrl'=>"/browse-by-city/",'browse_template'=>"browse_by_city.tpl"),$_smarty_tpl);?>
<br />
					</td>
					<td style="background-image: url('<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
right-panel-bg.png');" valign="bottom"><img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['image'][0][0]->getImageURL(array(),$_smarty_tpl);?>
