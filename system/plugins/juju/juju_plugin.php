				...
				if ($results instanceof DOMNodeList) {
					foreach ($doc->getElementsByTagName('item') as $result) {
						...
						$listings[] = array(
							...
							'api'             => 'juju',
							'code'            => '<span id="juju_at"><a href="' . SJB_Request::getProtocol() . '://www.juju.com/">jobs</a> by <a href="' . SJB_Request::getProtocol() . '://www.juju.com/" title="Job Search"><img src="' . SJB_Request::getProtocol() . '://www.job-search-engine.com/assets/images/juju_logo.png" style="width: 54px; height: auto; border: 0; vertical-align: middle;"></a></span>'
						);
					}
				}
