...
class IndeedPlugin extends SJB_PluginAbstract
{
	...
	public static function getListingsFromIndeed($params)
	{
		...
		// SET PARAMS FOR REQUEST
			...
			$country = !empty($criteria['Location_Country']['multi_like'][0]) ? $criteria['Location_Country']['multi_like'][0] : SJB_Settings::getSettingByName('IndeedCountry');
						...
						foreach ($results as $node) {
							foreach ($node->getElementsByTagName('result') as $result) {
								...
								$indeedListings [$jobKey] = array(
									...
									'api'			 => 'indeed',
									'code'			 => '<span id="indeed_at"><a href="' . SJB_Request::getProtocol() . '://www.indeed.com/">jobs</a> by <a href="' . SJB_Request::getProtocol() . '://www.indeed.com/" title="Job Search"><img src="' . SJB_Request::getProtocol() . '://www.indeed.com/p/jobsearch.gif" style="border: 0; vertical-align: middle;" alt="Indeed job search"></a></span>',
