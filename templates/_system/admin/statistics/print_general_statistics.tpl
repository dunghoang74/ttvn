...
<table align="center" style="border:0px!important;"><tr><td style="border:0px!important;">
<table style="font-size: 12px">
	...
	<tr><td style="text-align: center; font-weight: bold">Popularity</td><td colspan="{$countItems - 2}"></td></tr>
	<tr>
	...
	{if $filter.users == 1}
	<tr><td style="text-align: center; font-weight: bold">Users</td><td colspan="{$countItems - 2}"></td></tr>
	...
	<tr><td style="text-align: center; font-weight: bold">Listings</td><td colspan="{$countItems - 2}"></td></tr>
	...
	<tr><td style="text-align: center; font-weight: bold">Applications</td><td colspan="{$countItems - 2}"></td></tr>
	<tr>
	...
	{if $filter.alerts == 1}
	<tr><td style="text-align: center; font-weight: bold">Alerts</td><td colspan="{$countItems - 2}"></td></tr>
...
<tr><td style="border:0px!important;">
