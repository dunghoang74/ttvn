...
<h3>
	Number of Views and Applications per Period by 
	{if $filter == 'sid'}
		Job
	{elseif $filter == 'JobCategory'}
		Job’s Category
...
<table width="60%" style="border:0px!important; display: none; font-size: 12px;" id="graph" align="center">
	<tr>
		<td style="border:0px!important; text-align: center; font-weight: bold;">Number of Jobs Viewed</td>
		<td style="border:0px!important; text-align: center; font-weight: bold;">Number of applications Received</td>
	</tr>
	...
	<tr>
		<td style="padding-left: 100px; border: 0px!important;"><input type=button value="[[Print]]" onClick="this.style.display='none';window.print();"></td>
	</tr>
</table>
</div>