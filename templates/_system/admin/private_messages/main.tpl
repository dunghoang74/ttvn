{breadcrumbs}
	<a href="{$GLOBALS.site_url}/manage-{if $user_group_info.id == 'Employer' || $user_group_info.id == 'JobSeeker'}{$user_group_info.id|lower}s{else}{$user_group_info.id|lower}-users{/if}/?restore=1">
