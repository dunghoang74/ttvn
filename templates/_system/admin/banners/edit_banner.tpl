...
<fieldset>
	...
	<form method="post" enctype="multipart/form-data">
		<div>
			<table>
				<tr><td width="150px">Upload Banner File</td><td><input type="radio" name="bannerType" value="file" {if $banner.bannerType == 'file' || $banner.bannerType == ''}checked="checked"{/if} onclick="chooseBannerType('file');" /></td></tr>
				<tr><td>Insert Banner Code</td><td><input type="radio" name="bannerType" value="code"  {if $banner.bannerType == 'code'}checked="checked"{/if} onclick="chooseBannerType('code');"/></td></tr>
			</table>	
		</div>
		<table>
