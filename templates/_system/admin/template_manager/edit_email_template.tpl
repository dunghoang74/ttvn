...
<fieldset>
	...
	<div class="email-tpl-vars">
		<ul class="et-vars-groups">
			...
			<span class="spec-vars-var">{literal}{$name}{/literal} - name ofa user that submitted a comment</span>
			<span class="spec-vars-var">{literal}{$email}{/literal} - useremail</span>
