{if $template_name eq 'display_resume.tpl' || $template_name eq 'display_job.tpl' || $template_name eq 'search_form_resumes.tpl' || $template_name eq 'search_form.tpl'}
	<p class="note">Warning: If you want to change the layout of this form please use <a href="{$GLOBALS.site_url}/form-builders/">From Builder</a>. Direct changing of this template may lead to unpredictable results.</p>
{/if}
