...
<div id="error" class="error" style="display:none;"></div>
	<div id="settingsPane">
			...
			<form method="post" action="">
				...
				<input type="hidden" name="action" value="save">
					...
					<div id="autobackupSettings" style="display: none;">
						...
						<table width="100%">
							<tr>
								<td>[[Backup Type]]:</td><td> <select name='backup_type' id='backup_type_auto'>
							...
							<tr>	<td>[[Backup frequency]]:</td><td> <select name='backup_frequency' id='backup_frequency'>
							...
							<tr>
								<td><p>[[Backup will be expired and deleted after]]:</td><td> <input type="text" id="backup_expired_period" name="backup_expired_period" value="{$settings.backup_expired_period|escape:"html"}"> [[days]]</p>
									<span class="note">[[Leave empty or put zero for unlimited backup lifetime]]</span></td>
							</tr>
							<tr>
								<td>[[Save backup to FTP]]:</td><input type="hidden" name="ftp_backup" value="0" /> <td><input type="checkbox" id="ftp_backup" name="ftp_backup" {if $settings.ftp_backup}checked="checked"{/if}>
		...
		<form method="post" action="" enctype="multipart/form-data" id='restoreForm' onsubmit = "return restore();">
			...
			<div class="clr"><br/></div>
            <div id='progbarRestore'></div>		</form>
		</div>
	</div>	
...
<script type="text/javascript">
	...
	function submitForm() {
		...
		$("#progbar").html('{/literal}<img style="vertical-align: middle" src="{$GLOBALS.user_site_url}/system/ext/jquery/progbar.gif" alt="Please wait ..." /> &nbsp; Please wait ...{literal}');
	...
	function restore() {
		...
		$("#progbarRestore").html('{/literal}<img style="vertical-align: middle" src="{$GLOBALS.user_site_url}/system/ext/jquery/progbar.gif" alt="Please wait ..." /> &nbsp; Please wait ...{literal}');
