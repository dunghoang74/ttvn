		...
		<tbody>
			<tr class="oddrow">
				...
				<td>
					...
					<div stype="font-size:11px">[[First column should be State/Region Code, second column should be State/Region Name]]</div>
					<div class="clr"><br/></div>
					<div class="floatRight"><input type="submit" name="action" value="[[Import]]" class="greenButton" /></div>				</td>
			</tr>
		</tbody>
	</table>
</form>