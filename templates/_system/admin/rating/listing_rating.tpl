...
<form method="post" name="rating" action="{$GLOBALS.site_url}/listing-rating/">
	...
	<p>
		...
		<input onClick="if(!confirm('Are you sure you want to delete this comments?')) return false; document.forms['rating'].elements['action'].value = 'delete'; return true" value="Delete" class="deleteButton" type="submit">
	</p>
