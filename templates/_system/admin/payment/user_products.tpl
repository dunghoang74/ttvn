				...
				<td>
					...
					{if $contract.availableContactViews}
						{foreach from=$contract.availableContactViews item=availableContactViews}
							<div>[[{$availableContactViews.name} Contact details left to view]]: {$availableContactViews.viewsLeft}</div>
						{/foreach}
					{/if}
				</td>
