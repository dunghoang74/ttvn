...
{/if}
{literal}
var userFieldId = "{/literal}{$user_profile_field_info.id}{literal}";
...
function showMessageWindow()
{
	$("#messageWindow").dialog({
		...
		height: 200,
		buttons: {
			"{/literal}{$smarty.capture.change_anyway|escape:"javascript"}{literal}": function () {
				$('#fieldData').submit();
			},
			"{/literal}{$smarty.capture.don_t_change|escape:"javascript"}{literal}": function () {
