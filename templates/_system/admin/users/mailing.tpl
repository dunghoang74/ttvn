...
<script type="text/javascript">
	...
	var site_url = {/literal}'{$GLOBALS.site_url}'{literal};

	$(function() {
        var action = {/literal}'{$smarty.get.edit}'{literal};
        if (! action) {
	...
	function showSendWindow(mail_id)
	{
		...
		$("#test_mailer").attr({title: "{/literal}{$smarty.capture.test_send|escape:"javascript"}{literal}"});
		$("#test_mailer").dialog();
	}
