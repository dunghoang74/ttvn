<script type="text/javascript">
	...
	function setParam(param, value, param2, value2)  {
		...
		formSubmit("{$GLOBALS.site_url}/manage-{if $userGroupInfo.id == 'Employer' || $userGroupInfo.id == 'JobSeeker'}{$userGroupInfo.id|lower}s{else}{$userGroupInfo.id|lower}-users{/if}/", formID);
		return false; 
	}
