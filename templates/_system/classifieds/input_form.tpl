...
<div id="social_autoFill" class="{$socialAutoFillData.network}_16">
	...
	{else}
	<a href="{$GLOBALS.site_url}/add-listing/?listing_type_id={$listingTypeID|escape:'html'}&amp;product_sid={$productSID}&amp;autofill" title="">[[Auto-fill resume from my {$socialAutoFillData.network} profile]]</a>
	{/if}
	{else}
