{capture name=patternEvalReplace}/([\w\d.]+)/i{/capture}
{capture name=replacementEvalReplace}display property="\1"{/capture}
			...
			{elseif $theField.type eq "location"}
				...
				{if $theField.html}
					<tr>
						<td>
							<strong>[[{$theField.caption}]]:</strong>
							{capture name=replacementEvalReplaceLocation}display property="\1" parent=$theField.id{/capture}
