			...
			<td>
				<div class="listing-section">
					...
					<div class="listing-info">
						...
						<div class="right-side">{if $listing.user.Logo.file_url}
							<a href="{$GLOBALS.site_url}/company/{$listing.user.id}/{$listing.user.CompanyName|regex_replace:"/[\s\/\\\\]/":"-"|escape:"url"}/"><center><img src="{$listing.user.Logo.file_url}" alt="" /></center></a>
							{else}
								<center>&nbsp;</center>
							{/if}
						</div>
